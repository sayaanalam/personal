...
// Your existing NavigationItems array
...
const NavItem = ({ href, children }: React.PropsWithChildren<{ href: string }>) => {
  ...
  return (
    <li>
      <Link
        href={href}
        className={`relative block px-3 py-2 transition ${isActive ? 'text-primary' : 'hover:text-primary'}`}
      >
        {children}
      </Link>
    </li>
...
const DesktopNavigation = () => {
  return (
    <nav className="flex justify-center">
      <div className="max-w-4xl w-full px-4"> {/* Adjust the max-width to your desired width */}
